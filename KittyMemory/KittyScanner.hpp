...
protected:
    ...
    bool _fixedBySoInfo;
    KittyMemoryMap::ProcMap _baseSegment;
    std::vector<KittyMemoryMap::ProcMap> _segments;
    std::vector<KittyMemoryMap::ProcMap> _bssSegments;
...
public:
     ...
     */
    ElfScanner(IKittyMemOp *pMem, uintptr_t elfBase, const std::vector<KittyMemoryMap::ProcMap> &maps);
    ...
    ElfScanner(IKittyMemOp *pMem, uintptr_t elfBase)
        : ElfScanner(pMem,
                     elfBase,
                     (pMem ? KittyMemoryMap::getAllMaps(pMem->processID()) : std::vector<KittyMemoryMap::ProcMap>()))
    {
    }
     ...
     * @param maps The vector of cached process memory maps.
     */
    ElfScanner(IKittyMemOp *pMem, const kitty_soinfo_t &soinfo, const std::vector<KittyMemoryMap::ProcMap> &maps);
     ...
     */
    KittyMemoryMap::ProcMap baseSegment() const
    {
        return _baseSegment;
    }
     ...
     */
    std::vector<KittyMemoryMap::ProcMap> segments() const
    {
        return _segments;
    }
     ...
     */
    std::vector<KittyMemoryMap::ProcMap> bssSegments() const
    {
        return _bssSegments;
    }
...
public:
     ...
     */
    inline ElfScanner createWithMap(const KittyMemoryMap::ProcMap &map) const
    {
...
public:
    ...
    inline kitty_soinfo_t somainInfo() const
    {
        ...
        return infoFromSoInfo_(somain(), KittyMemoryMap::getAllMaps(_pMem->processID()));
    }
    ...
    inline kitty_soinfo_t sonextInfo() const
    {
        ...
        return infoFromSoInfo_(sonext(), KittyMemoryMap::getAllMaps(_pMem->processID()));
    }
...
private:
    kitty_soinfo_t infoFromSoInfo_(uintptr_t si, const std::vector<KittyMemoryMap::ProcMap> &maps) const;
};
...
public:
    ...
    inline kitty_soinfo_t soheadInfo() const
    {
        ...
        return infoFromSoInfo_(_sohead, KittyMemoryMap::getAllMaps(_pMem->processID()));
    }
